...
* Beamforming branch: updated GUI and signal processing files to include new window for measuring beamforming antenna patter. The tool generates theoretical antenna array pattern and compares against measured results. Rotate antenna array and click corresponding angle buttons to enter measured pattern.
